...
setwd("//poise.homeoffice.local/data/RAP/DomGroup/LEE/Analysis/Unit values/Value of a clear-up/Arrests Regression")             # Setting the code to run from this directory
dates <- readRDS("Code/useful_outputs/dates_list.RDS") # Import list of dates (YYYY-MM)
police.forces <- readRDS("Code/useful_outputs/police_force_list.RDS")
...
clearup.cats <- readRDS("Code/useful_outputs/clearup_categories.rds")     # Import the list of outcomes which we will assign as 'clearups'
